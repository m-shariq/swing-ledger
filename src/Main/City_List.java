 ...
 * @author shari
 */
public class City_List extends javax.swing.JFrame {
...
Connection cnx;
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        C_Group type = new C_Group(id,description);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        String description = textField_description.getText();
        C_Group type = new C_Group(0,description);
 ...
 private void updatetable(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(City_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
