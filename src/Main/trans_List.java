 ...
 * @author shari
 */
public class trans_List extends javax.swing.JFrame {
...
Connection cnx;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(1030, 40, 240, 180);
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        T_Group type = new T_Group(id,description);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        String description = textField_description.getText();
        T_Group type = new T_Group(0,description);
 ...
 private void updatetable(){
    ...
    try {
        ...
        String sql = "SELECT * FROM `tran_group`";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new trans_List().setVisible(true);
            }
        });
    }
